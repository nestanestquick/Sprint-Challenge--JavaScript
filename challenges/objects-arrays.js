...
*/
const animalNames = [];
let combinedNames = zooAnimals.forEach(function(i){
...
*/
const populationTotal = zooAnimals.reduce((populationTotal, populationSeparate) => {
  return populationTotal + populationSeparate.population;
}, 0);
